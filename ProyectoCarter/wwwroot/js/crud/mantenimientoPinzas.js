// wwwroot/js/crud/mantenimientoPinzas.js
class MantenimientoPinzasCRUD extends CRUDDynamic {
    constructor() {
        super('MantenimientoPinzas', 'tblMantenimientoPinzas', 'formMantenimientoPinzas', {
            hasStatus: true
        });
        this.mockData = [
            { id: 1, modelo: 'PZ-2000', numeroSerie: 'SN12345', ultimoMantenimiento: '2023-05-15', proximoMantenimiento: '2023-11-15', responsable: 'Juan Pérez', status: 'Operativo' }
        ];
    }
...
document.addEventListener("DOMContentLoaded", function () {
    window.crud = new MantenimientoPinzasCRUD();
});